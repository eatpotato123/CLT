...
! fix the dropped point with x1=0 for difficulty in openacc speedup
	do jz=iz_first_irpt,iz_last_irpt
	do jx=ix_first_irpt,ix_last_irpt
	if((gdtp_ep(jx,jz,1).ge.4).or.(gdtp_ep(jx,jz,4).ge.4)) x1(jx,jz,:,:)=0.d0
	enddo
	enddo
! 	goto 911
! 
