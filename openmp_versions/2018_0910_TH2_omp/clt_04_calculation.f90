...
!	do jx=ix_first+2,ix_last-2
	...
	!omp parallel default(shared) &
	! copyin(gdtp_ep,ax1_irz,bx1_irz,cx1_irz,dx1_irz,axbp_irz,bxbp_irz,cxbp_irz,axbm_irz,bxbm_irz,cxbm_irz,xx,ax1,bx1,cx1,dx1) &
	! copyin(xint1_dx,xint1_dz,xint3_dx,xint5_dz,xint3,xint5,iz_first,iz_last,ix_first,ix_last) &
	! copyin(xint2_dx,xint2_dz,gamma) &
	! copyin(cint1,cint2,cint3) &
	! copyin(xint3_dz,xint4,xint4_dx,xint4_dz,xint5_dx) &
	! copyin(az1,bz1,cz1,dz1) &
	! copyin(az1_irx,bz1_irx,cz1_irx,dz1_irx,azbp_irx,bzbp_irx,czbp_irx,azbm_irx,bzbm_irx,czbm_irx) &
	! copyin(viscous,implicitv,pmu,pmux,pmuz,fmu,fmux,fmuz) &
...
! total(mx*mz*19+mx+3)=7603
	...
	!$acc annotate(slice(x1(*,*,jy,3),x1(*,*,jy,4),xy(*,*,jy,3),xy(*,*,jy,4),xr2(*,*,jy,3),xr2(*,*,jy,4),xr2(*,*,jy,5),x1r(*,*,jy,3),x1r(*,*,jy,4),x1r(*,*,jy,5),xz2(*,*,jy,3),xz2(*,*,jy,4),xz2(*,*,jy,5),xy2(*,*,jy,3),xy2(*,*,jy,4),xy2(*,*,jy,5),xdif(*,*,jy,3),xdif(*,*,jy,4),xdif(*,*,jy,5)))
