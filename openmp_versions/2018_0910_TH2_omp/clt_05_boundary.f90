...
! IR poinrs cost about 6s for total 165s
! mpi_transfer ~ 15s
! x1 at first and last ~ 14s
! the boundary subroutine cost about 35s for total 165s
...
! fixed boundary
	...
	do m=1,8
	do jy=iy_first,iy_last
	x_8bndx(:,jy,m)=x1_8bndx(:,jy,m)+xint_8bndx(:,m)
	x_8bndz(:,jy,m)=x1_8bndz(:,jy,m)+xint_8bndz(:,m)
	enddo
	enddo
	endif
